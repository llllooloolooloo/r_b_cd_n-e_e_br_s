...
for (var i = 0; i < arrayLength; i++) {
    if (top.location.href.indexOf(myStringArray[i]) > -1) {
...
if (top.location.href.indexOf("http://bitcoinglobalclub.com/mlm/pages/login/login.php") > -1) {
